				...
				<div class="product_create_inner">
					...
					<div class="product_create_content">
						<div class="create_layout">
							<label>상품 번호</label> <input class="form-control" name='pid'
						...
						<div class="form-group">
							<label for="lcategory">대분류</label> <select id="lcateSelect"
						...
						<div class="form-group">
							<label>소분류</label> <select id="scateSelect" name="scategory"
								size="1">
						...
						<div class="create_layout">
                            <div class="layout_subject _asterisk"><label>상품명</label> <input class="form-control" name='pname'
								value='<c:out value="${product.pname }"/>'>

						</div>
						<div class="create_layout">
                            <div class="layout_subject _asterisk"><label>상품상세</label> <input class="form-control" name='detail'
								value='<c:out value="${product.detail }"/>'>

						</div>

						<div class="create_layout">
                            <div class="layout_subject _asterisk">
							<label>이미지</label> <input class="form-control" name='img1'
								value='<c:out value="${product.img1 }"/>'>
						...
						<div class="create_layout">
                            <div class="layout_subject _asterisk">
							<label>재고량</label> <input class="form-control" name='pstock'
								value='<c:out value="${product.pstock }"/>'>

						</div>

						<div class="form-group">
							<label>상품상태</label> <input class="form-control" name='pstatus'
