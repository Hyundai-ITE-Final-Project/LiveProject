...
<body>
	<form role="form" action="/manage/registerProduct" method="post"
		...
		<div class="form-group">
			<label>소분류</label> <select id="scateSelect" name="scategory" size="1">
				...
				<option value="135" class="scate13">멸치, 건어물, Dried-H, 어부의밥상</option>
		...
		<div class="form-group">
			<label>상품상세</label> <input class="form-control" name='detail'>
		</div>
		...
		<div class="form-group">
			<label>재고</label> <input class="form-control" name='pstock'>
		</div>
		...
		<div class="form-group">
			<label>pstatus</label> <input class="form-control" name='pstatus'>
		</div>
